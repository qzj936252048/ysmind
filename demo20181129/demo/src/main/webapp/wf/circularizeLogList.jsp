...
<div data-toggle="topjui-layout" data-options="fit:true">
        ...
        <table data-toggle="topjui-datagrid"
		       data-options="id: 'circularizeLogDg',singleSelect:false,selectOnCheck:'checked',checkOnSelect:'checked',
		            url: ''
				">
			<thead frozen="true">
			<tr>
		    ...
		    <thead>
		    <tr>
                <th data-options="field:'recordName',title:'审批记录名称',sortable:true,width:300,formatter:formatEditWindow"></th>
...
<!-- layout布局 结束 -->
<!-- 表格工具栏开始 -->
<div id="circularizeLogDg-toolbar" class="topjui-toolbar" data-options="grid:{type:'datagrid',id:'circularizeLogDg'}">
...
function encodeHtml(s) {  
	...
	var ctx = $("#ctx").val();
	$(function() {  
		initSortR("circularizeLogDg","mySort") 
	    //datagrid 初始化的时候默认不加载 点击按钮的时候再加载数据？
	    var opts = $("#circularizeLogDg").datagrid("options");
	    opts.url = "";
	    //initCrud();
	});
    ...
    function myNormalQuery(){
		...
		var url = "${ctx}/wf/circularizeLog/listData?queryType="+queryType;
		url = urlAddParams(url);
		var opts = $("#circularizeLogDg").datagrid("options");
	    opts.url = url;
        $('#circularizeLogDg').iDatagrid('reload', {
