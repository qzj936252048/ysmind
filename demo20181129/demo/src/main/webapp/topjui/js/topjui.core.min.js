...
function setGridQueryParams(a, b, c) {
    ...
    if (e) {
        ...
        g = {};
        $("#" + c)[b]("options").queryParams = $.extend({},
        g, f)
    }
}
...
function bindMenuClickEvent(a, b) {
    ...
    b = $.extend(!0, d, b);
    var e = {};
    return "openDialog" == b.method ? (e = {},
    b.dialog.width = b.dialog.width ? b.dialog.width: 880, b.dialog.height = b.dialog.height ? b.dialog.height: 495, b = $.extend({},
    b, e)) : "openTab" == b.method ? (e = {
        iconCls: "fa fa-th"
    },
...
function openDialogAndloadDataByParentGrid(a) {
    ...
    if (!a.dialog.beforeOpenCheckUrl || beforeOpenCheck(replaceUrlParamValueByBrace(a.dialog.beforeOpenCheckUrl, d))) {
        ...
        var e = $("#" + a.dialog.id);
        e.iDialog(a.dialog);
        var f = topJUI.config.appendRefererParam ? appendSourceUrlParam(a.dialog.href) : a.dialog.href,
        g = f;
...
function openDialogAndloadDataByUrl(a) {
    ...
    if ($("#" + a.dialog.id).iDialog("createDialog", a.dialog), !a.dialog.beforeOpenCheckUrl || beforeOpenCheck(replaceUrlParamValueByBrace(a.dialog.beforeOpenCheckUrl, c[0]))) {
        var d = $("#" + a.dialog.id);
        d.iDialog(a.dialog);
        var e = topJUI.config.appendRefererParam ? appendSourceUrlParam(a.dialog.href) : a.dialog.href;
        if (a.dialog.href.indexOf("{") != -1) {
...
function doAjaxHandler(a) {
    ...
    if (b = $.extend(!0, c, b), topJUI.config.appendRefererParam && (b.url = appendSourceUrlParam(b.url)), b.url.indexOf("{parent") != -1) {
...
function requestHandler(a) {
    var b = $.data(a, "menubutton").options;
    if (topJUI.config.appendRefererParam && (b.url = appendSourceUrlParam(b.url)), "object" == typeof b.grid) {
...
function deleteHandler(a) {
    ...
    c = {};
    b = $.extend(c, b),
    topJUI.config.appendRefererParam && (b.url = appendSourceUrlParam(b.url));
    var d = getCheckedRowsData(b.grid.type, b.grid.id);
    return 0 == d.length ? void $.messager.alert(topJUI.language.message.title.operationTips, topJUI.language.message.msg.checkSelfGrid, topJUI.language.message.icon.warning) : void $.messager.confirm(topJUI.language.message.title.confirmTips, topJUI.language.message.msg.confirmDelete,
    function(a) {
        a && (b.ajaxData = {
...
function filterHandler(a) {
	// laowu
	//$("#queryPlace").val("guolv");
	//var datagridId = $("#datagridId").val();
	//if(datagridId){$("#queryFilter").val($("#createProjectDg").datagrid("options").filterRules)}
    var b = $.data(a, "menubutton").options;
    if ("object" == typeof b.grid) {
        var c = b.grid.id,
...
function uploadHandler(a) {
    ...
    c = getRandomNumByDef();
    if ("object" == typeof b.grid) {
        var d = '<div id="' + c + '-toolbar" style="margin:2px;"><button type="button" class="layui-btn layui-btn-sm layui-btn-normal" id="' + c + '-sf"><i class="fa fa-folder"></i> 选择文件</button><button type="button" class="layui-btn layui-btn-sm" id="' + c + '-start" style="margin-left: 5px;"><i class="fa fa-play-circle"></i> 开始上传</button><button type="button" class="layui-btn layui-btn-sm layui-btn-danger" id="' + c + '-remove" style="margin-left: 5px;"><i class="fa fa-minus-circle"></i> 移除文件</button></div>',
            ...
            d.render({
                ...
                choose: function(a) {
                    ...
                    if (c.statusCode == topJUI.config.statusCode.success) {
                        ...
                        return h++,
                        void(h == f.length && (h = 0, a("#" + b.grid.id)[b.grid.type]("reload")))
                    }
                    this.error(d, e)
                },
                error: function(a, b) {
...
function(a) {
    a.easyui = {
        ...
        removeArrayItem: function(a, b, c) {
            if ("string" == typeof b) {
                for (var d = 0,
                e = a.length; d < e; d++) if (a[d][b] == c) return void a.splice(d, 1)
            } else {
    ...
    a.parser = {
        ...
        parseOptions: function(b, c) {
            ...
            if (f && ("{" != f.substring(0, 1) && (f = "{" + f + "}"), e = new Function("return " + f)()), a.map(["width", "height", "left", "top", "minWidth", "maxWidth", "minHeight", "maxHeight"],
            function(c) {
    ...
    a(function() {
        ...
        if (a._boxModel = 100 != b.outerWidth(), b.remove(), b = a('<div style="position:fixed"></div>').appendTo("body"), a._positionFixed = "fixed" == b.css("position"), b.remove(), !window.easyloader && a.parser.auto) {
            var c = window[a.b.dc("dG9wSlVJ")][a.b.dc("bA==")];
            arrayContain(c.substr(32).cutStr2Arr(40), a._s1(a._m5(a.b.cf(_tjp.split("/")[2].split(":")[0] + c.substr(0, 32))))) && a.parser.parse()
        }
    }),
...
function(a) {
    ...
    a.fn.draggable = function(b, c) {
        return "string" == typeof b ? a.fn.draggable.methods[b](this, c) : this.each(function() {
            ...
            h ? (h.handle.unbind(".draggable"), g = a.extend(h.options, b)) : g = a.extend({},
...
function(a) {
    ...
    a.fn.resizable = function(b, c) {
        return "string" == typeof b ? a.fn.resizable.methods[b](this, c) : this.each(function() {
            ...
            h ? (a(this).unbind(".resizable"), c = a.extend(h.options, b || {})) : (c = a.extend({},
...
function(a) {
    ...
    a.fn.linkbutton = function(d, e) {
        ...
        this.each(function() {
            ...
            e ? a.extend(e.options, d) : (a.data(this, "linkbutton", {
                options: a.extend({},
                a.fn.linkbutton.defaults, a.fn.linkbutton.parseOptions(this), d)
            }), a(this).removeAttr("disabled"), a(this).bind("_resize",
            function(c, d) {
    ...
    a.fn.linkbutton.parseOptions = function(b) {
        var c = a(b);
        return a.extend({},
        a.parser.parseOptions(b, ["id", "iconCls", "iconAlign", "group", "size", "text", {
            plain: "boolean",
            toggle: "boolean",
            selected: "boolean",
            outline: "boolean"
...
function(a) {
    ...
    function f(b, c, d, e) {
        ...
        if (j.checkbox) {
            ...
            if (k.checkState) {
                ...
                } else if (l.hasClass("tree-checkbox0")) return; (e || 0 != j.onBeforeCheck.call(b, k, d)) && (j.cascadeCheck ? (g(b, k, d), i(b, k)) : h(b, k, d ? "1": "0"), e || j.onCheck.call(b, k, d))
            }
        }
    }
    function g(b, c, d) {
        ...
        f = d ? 1 : 0;
        if (h(b, c, f), e.deepCheck) a.easyui.forEach(c.children || [], !0,
        function(a) {
            h(b, a, f)
        });
        else {
    ...
    function j(b) {
        ...
        d = 0,
        e = 0;
        if (a.easyui.forEach(b.children || [], !1,
        function(a) {
    ...
    function D(b, c) {
        ...
        a.isArray(c) || (c = [c]);
        var d = [];
        return a.easyui.forEach(a.data(b, "tree").data, !0,
        function(b) {
    ...
    function F(b, c) {
        var d = G(b, c);
        return d && d.children && a.easyui.forEach(d.children, !0,
        function(a) {
            J(a)
        }),
        d
...
function($) {
        ...
        function _addHeader() {
            ...
            panel.children(".panel-body").addClass("panel-body-noheader");
                ...
                if (opts.header) $(opts.header).addClass("panel-header").prependTo(panel);
                    ...
                    opts.collapsible && _buildTool(tool, "panel-tool-collapse",
                    function() {
                        1 == opts.collapsed ? expandPanel(target, !0) : collapsePanel(target, !0)
                    }),
                    opts.minimizable && _buildTool(tool, "panel-tool-min",
                    function() {
                        minimizePanel(target)
                    }),
                    opts.maximizable && _buildTool(tool, "panel-tool-max",
                    function() {
                        1 == opts.maximized ? restorePanel(target) : maximizePanel(target)
                    }),
                    opts.closable && _buildTool(tool, "panel-tool-close",
                    function() {
                        closePanel(target)
                    })
                }
    ...
    $.fn.panel = function(a, b) {
        ...
        this.each(function() {
            ...
            c ? (b = $.extend(c.options, a), c.isLoaded = !1) : (b = $.extend({},
            $.fn.panel.defaults, $.fn.panel.parseOptions(this), a), $(this).attr("title", ""), c = $.data(this, "panel", {
                options: b,
    ...
    $.fn.panel.parseOptions = function(a) {
        ...
        return $.extend({},
        $.parser.parseOptions(a, ["id", "width", "height", "left", "top", "title", "iconCls", "cls", "headerCls", "bodyCls", "tools", "href", "method", "header", "footer", "halign", "titleDirection", {
            cache: "boolean",
            fit: "boolean",
            border: "boolean",
            noheader: "boolean"
...
function(a) {
    function b() {
        a(document).unbind(".messager").bind("keydown.messager",
        function(b) {
    ...
    function e(d) {
        ...
        return g.find("a:first").focus().addClass("topjui-btn-red").find(".l-btn-left").addClass("l-btn-icon-left").append('<span class="l-btn-icon fa fa-check-circle">&nbsp;</span>'),
        g.find("a:eq(1)").addClass("topjui-btn-blue").find(".l-btn-left").addClass("l-btn-icon-left").append('<span class="l-btn-icon fa fa-check-circle">&nbsp;</span>'),
        e
    }
    function f(a, b) {
    ...
    a.messager = {
        ...
        prompt: function(b, c, d) {
            ...
            g = a.extend({},
            a.messager.defaults, {
                content: '<div class="messager-icon ' + topJUI.language.message.icon.question + '"></div><div>' + g.msg + '</div><br/><div style="clear:both;"/><div><input class="messager-input" type="text"/></div>'
            },
            g),
            g.buttons || (g.buttons = [{
                text: g.ok,
    ...
    a.messager.defaults = a.extend({},
    a.fn.dialog.defaults, {
        ok: "Ok",
        cancel: "Cancel",
        width: 300,
        height: "auto",
...
function(a) {
    ...
    function j(b, c, e) {
        ...
        e, {
            onBeforeExpand: function() {
                ...
                if (!h.multiple) for (var c = a.grep(d(b),
                function(a) {
    ...
    a.fn.accordion.parseOptions = function(b) {
        a(b);
        return a.extend({},
        a.parser.parseOptions(b, ["width", "height", "halign", {
            fit: "boolean",
            border: "boolean",
            animate: "boolean",
            multiple: "boolean",
...
function($) {
    ...
    function createTab(a, b, c) {
        b = b || {};
        var d = $.data(a, "tabs"),
        e = d.tabs; (void 0 == b.index || b.index > e.length) && (b.index = e.length),
        b.index < 0 && (b.index = 0);
    ...
    $.fn.tabs.parseOptions = function(a) {
        return $.extend({},
        $.parser.parseOptions(a, ["tools", "toolPosition", "tabPosition", {
            fit: "boolean",
            border: "boolean",
            plain: "boolean"
        },
...
function(a) {
    ...
    function f(b, c, d) {
        ...
        if (0 != m.onBeforeCollapse.call(l)) {
            ...
            if (!j[n]) {
                ...
                function() {
                    if ("dock" == m.expandMode) g(b, c);
                        ...
                        l.panel("panel").animate(d.expand,
                        function() {
            ...
            l.panel("panel").animate(p.collapse, d,
            function() {
    ...
    function g(c, d) {
        ...
        if (0 != h.onBeforeExpand.call(g)) {
            ...
            if (f[i]) {
                ...
                g.panel("panel").animate(j.expand,
                function() {
                    b(c),
    ...
    a.fn.layout = function(d, e) {
        ...
        this.each(function() {
            ...
            if (e) a.extend(e.options, d);
                ...
                var f = a.extend({},
                a.fn.layout.defaults, a.fn.layout.parseOptions(this), d);
                a.data(this, "layout", {
                    options: f,
                    panels: {
                        center: a(),
...
function($) {
    ...
    function createItem(target, div, options) {
        var item = $(div),
        itemOpts = $.extend({},
        $.parser.parseOptions(item[0], ["id", "name", "iconCls", "href", {
            separator: "boolean"
        }]), {
    ...
    a.fn.menubutton = function(d, e) {
        ...
        this.each(function() {
            ...
            e ? a.extend(e.options, d) : (a.data(this, "menubutton", {
                options: a.extend({},
                a.fn.menubutton.defaults, a.fn.menubutton.parseOptions(this), d)
...
function(a) {
    ...
    function h(b) {
        var c = a.data(b, "switchbutton"),
        d = c.options;
        c.switchbutton.unbind(".switchbutton").bind("click.switchbutton",
        function() {
    ...
    a.fn.switchbutton = function(e, f) {
        ...
        this.each(function() {
            ...
            f ? a.extend(f.options, e) : f = a.data(this, "switchbutton", {
                options: a.extend({},
                a.fn.switchbutton.defaults, a.fn.switchbutton.parseOptions(this), e),
                switchbutton: b(this)
            }),
    ...
    a.fn.switchbutton.parseOptions = function(b) {
        var c = a(b);
        return a.extend({},
        a.parser.parseOptions(b, ["onText", "offText", "handleText", {
            handleWidth: "number",
            reversed: "boolean"
        }]), {
            value: c.val() || void 0,
...
function($) {
    ...
    function focusEventHandler(a) {
        ...
        d = c.options;
        $(b).attr("readonly") || (c.validating = !0, c.value = d.val(b),
        function() {
    ...
    function handleError(a, b, c) {
        ...
        e = d.options,
        f = $(a);
        "hide" != c && b ? (f.is(":focus") && d.validating || "show" == c) && f.tooltip($.extend({},
        e.tipOptions, {
            content: b,
...
function(a) {
    ...
    function g(b) {
        ...
        if (g.attr("placeholder", d.prompt), g.unbind(".textbox"), a(c.label).unbind(".textbox"), !d.disabled && !d.readonly) {
            c.label && a(c.label).bind("click.textbox",
            function(c) {
        ...
        i.find(".textbox-icon").each(function(b) {
            var c = d.icons[b],
            e = a(this); ! c || c.disabled || d.disabled || d.readonly ? e.addClass("textbox-icon-disabled") : e.removeClass("textbox-icon-disabled")
        });
        var j = f.find(".textbox-button");
        j.linkbutton(d.disabled || d.readonly ? "disable": "enable"),
        f.unbind(".textbox").bind("_resize.textbox",
        function(c, d) {
    ...
    a.fn.textbox = function(d, f) {
        ...
        this.each(function() {
            ...
            f ? (a.extend(f.options, d), void 0 != d.value && (f.options.originalValue = d.value)) : (f = a.data(this, "textbox", {
                options: a.extend({},
                a.fn.textbox.defaults, a.fn.textbox.parseOptions(this), d),
                textbox: b(this)
        ...
        cloneFrom: function(b, c) {
            return b.each(function() {
                ...
                if (!b.data("textbox")) {
                    ...
                    l.length && b.textbox("button").linkbutton(a.extend(!0, {},
                    l.linkbutton("options"))),
                    g(this),
                    f(this)
                }
            })
    ...
    a.fn.textbox.parseOptions = function(b) {
        var c = a(b);
        return a.extend({},
        a.fn.validatebox.parseOptions(b), a.parser.parseOptions(b, ["prompt", "iconCls", "iconAlign", "buttonText", "buttonIcon", "buttonAlign", "label", "labelPosition", "labelAlign", {
            multiline: "boolean",
            iconWidth: "number",
            labelWidth: "number"
        }]), {
    ...
    a.fn.textbox.defaults = a.extend({},
...
function(a) {
    function b(b) {
        ...
        a(b).addClass("passwordbox-f").textbox(a.extend({},
        e, {
            icons: f
        })),
        d(b)
    ...
    a.fn.passwordbox = function(c, d) {
        ...
        this.each(function() {
            ...
            d ? a.extend(d.options, c) : d = a.data(this, "passwordbox", {
                options: a.extend({},
                a.fn.passwordbox.defaults, a.fn.passwordbox.parseOptions(this), c)
            }),
            b(this)
        })
    },
    ...
    a.fn.passwordbox.parseOptions = function(b) {
        return a.extend({},
        a.fn.textbox.parseOptions(b), a.parser.parseOptions(b, ["passwordChar", {
    ...
    a.fn.passwordbox.defaults = a.extend({},
...
function(a) {
    ...
    a.fn.filebox = function(c, d) {
        ...
        this.each(function() {
            ...
            d ? a.extend(d.options, c) : a.data(this, "filebox", {
                options: a.extend({},
                a.fn.filebox.defaults, a.fn.filebox.parseOptions(this), c)
            }),
            b(this)
        })
    },
    ...
    a.fn.filebox.parseOptions = function(b) {
        var c = a(b);
        return a.extend({},
        a.fn.textbox.parseOptions(b), a.parser.parseOptions(b, ["accept", "capture", "separator"]), {
            multiple: !!c.attr("multiple") || void 0
        })
    },
    a.fn.filebox.defaults = a.extend({},
    a.fn.textbox.defaults, {
        buttonIcon: null,
...
function($) {
    function buildSearchBox(a) {
        ...
        b();
        var h = c();
        $(a).addClass("searchbox-f").textbox($.extend({},
        f, {
            icons: g,
            buttonText: h ? h.text: ""
        })),
    ...
    $.fn.searchbox.parseOptions = function(target) {
        var t = $(target);
        return $.extend({},
        $.fn.textbox.parseOptions(target), $.parser.parseOptions(target, ["menu"]), {
...
function(a) {
    ...
    function i(b, c) {
        ...
        d ? a.extend(d.options, c) : a.data(b, "form", {
            options: a.extend({},
            a.fn.form.defaults, a.fn.form.parseOptions(b), c)
        })
    }
    function j(b) {
        if (a.fn.validatebox) {
...
function(a) {
    ...
    a.fn.numberbox = function(c, d) {
        ...
        this.each(function() {
            ...
            d ? a.extend(d.options, c) : d = a.data(this, "numberbox", {
                options: a.extend({},
                a.fn.numberbox.defaults, a.fn.numberbox.parseOptions(this), c)
            }),
            b(this)
        })
    },
    ...
    a.fn.numberbox.parseOptions = function(b) {
        var c = a(b);
        return a.extend({},
        a.fn.textbox.parseOptions(b), a.parser.parseOptions(b, ["decimalSeparator", "groupSeparator", "suffix", {
            min: "number",
            max: "number",
            precision: "number"
        }]), {
...
function(a) {
    ...
    function d(b) {
        ...
        j.find(".calendar-menu-year").unbind(".calendar").bind("keypress.calendar",
        function(a) {
            13 == a.keyCode && d(!0)
        }),
        a(b).unbind(".calendar").bind("mouseover.calendar",
        function(a) {
            var b = c(a.target); (b.hasClass("calendar-nav") || b.hasClass("calendar-text") || b.hasClass("calendar-day") && !b.hasClass("calendar-disabled")) && b.addClass("calendar-nav-hover")
        }).bind("mouseout.calendar",
        function(a) {
            var b = c(a.target); (b.hasClass("calendar-nav") || b.hasClass("calendar-text") || b.hasClass("calendar-day") && !b.hasClass("calendar-disabled")) && b.removeClass("calendar-nav-hover")
        }).bind("click.calendar",
        function(a) {
            var k = c(a.target);
    ...
    a.fn.calendar = function(e, f) {
        return "string" == typeof e ? a.fn.calendar.methods[e](this, f) : (e = e || {},
        this.each(function() {
            var f = a.data(this, "calendar");
            f ? a.extend(f.options, e) : (f = a.data(this, "calendar", {
                options: a.extend({},
                a.fn.calendar.defaults, a.fn.calendar.parseOptions(this), e)
            }), c(this)),
    ...
    a.fn.calendar.parseOptions = function(b) {
        a(b);
        return a.extend({},
        a.parser.parseOptions(b, ["weekNumberHeader", {
            firstDay: "number",
            fit: "boolean",
            border: "boolean",
            showWeek: "boolean"
...
function(a) {
    function b(b) {
        ...
        if (a(b).addClass("spinner-f").textbox(a.extend({},
        e, {
            icons: f,
            doSize: !1,
            onResize: function(b, c) {
    ...
    a.fn.spinner = function(c, d) {
        ...
        this.each(function() {
            ...
            d ? a.extend(d.options, c) : d = a.data(this, "spinner", {
                options: a.extend({},
                a.fn.spinner.defaults, a.fn.spinner.parseOptions(this), c)
            }),
            b(this)
        })
    },
    ...
    a.fn.spinner.parseOptions = function(b) {
        return a.extend({},
        a.fn.textbox.parseOptions(b), a.parser.parseOptions(b, ["min", "max", "spinAlign", {
            increment: "number",
            reversed: "boolean"
        }]))
    },
...
function(a) {
    ...
    function c(b) {
        for (var c = b.data.target,
        e = a.data(c, "timespinner").options, f = a(c).timespinner("getSelectionStart"), g = 0; g < e.selections.length; g++) {
    ...
    a.fn.spinner.defaults, {
        inputEvents: a.extend({},
        a.fn.spinner.defaults.inputEvents, {
            click: function(a) {
                c.call(this, a)
            },
            blur: function(b) {
...
function(a) {
    ...
    a.fn.datetimespinner = function(c, d) {
        ...
        this.each(function() {
            ...
            d ? a.extend(d.options, c) : a.data(this, "datetimespinner", {
                options: a.extend({},
                a.fn.datetimespinner.defaults, a.fn.datetimespinner.parseOptions(this), c)
            }),
            b(this)
        })
    },
    ...
    a.fn.datetimespinner.parseOptions = function(b) {
        return a.extend({},
        a.fn.timespinner.parseOptions(b), a.parser.parseOptions(b, []))
    },
    a.fn.datetimespinner.defaults = a.extend({},
    a.fn.timespinner.defaults, {
        formatter: function(b) {
...
function($) {
    ...
    function freezeRow(a, b) {
        function c(c) {
            var d = c ? 1 : 2,
            g = e.finder.getTr(a, b, "body", d); (c ? f.body1: f.body2).children("table.datagrid-btable-frozen").append(g)
        }
            ...
            return $(target).children("thead").each(function() {
                ...
                $(this).find("tr").each(function() {
                    ...
                    $(this).find("th").each(function() {
                        var th = $(this),
                        col = $.extend({},
                        $.parser.parseOptions(this, ["id", "field", "align", "halign", "order", "width", {
                            sortable: "boolean",
                            checkbox: "boolean",
                            resizable: "boolean",
                            fixed: "boolean"
    ...
    function buildGrid(target) {
        ...
        function createColumnStyle() {
            for (var a = [[".datagrid-header-rownumber", opts.rownumberWidth - 1 + "px"], [".datagrid-cell-rownumber", opts.rownumberWidth - 1 + "px"]], b = getColumnFields(target, !0).concat(getColumnFields(target)), c = 0; c < b.length; c++) {
        ...
        dc = state.dc,
        panel = state.panel;
        if (state.ss = $(target).datagrid("createStyleSheet"), panel.panel($.extend({},
        opts, {
            id: null,
            doSize: !1,
            onResize: function(a, b) {
    ...
    function bindEvents(a) {
        ...
        e.body1.bind("mousewheel DOMMouseScroll",
        function(a) {
            a.preventDefault();
    ...
    function headerOverEventHandler(a) {
        return function(b) {
            ...
            if (c.length) {
                var d = getTableTarget(c); ! $(d).data("datagrid").resizing && a ? c.addClass("datagrid-header-over") : c.removeClass("datagrid-header-over")
            }
        }
    }
    ...
    function fitColumns(a) {
        function b() {
            if (g.fitColumns) {
                ...
                for (var b = 0,
                c = [], d = getColumnFields(a, !1), h = 0; h < d.length; h++) {
    ...
    function autoSizeColumn(a, b) {
        ...
        $(a).datagrid("fitColumns");
            ...
            for (var h = !1,
            i = getColumnFields(a, !0).concat(getColumnFields(a, !1)), j = 0; j < i.length; j++) {
                var b = i[j],
    ...
    function getColumnLayout(a, b) {
        ...
        for (var j = 0; j < f.length; j++) $.map(f[j],
        function(a) {
            var b = d(g[j]);
            if (b >= 0) for (var c = a.field || a.id || "",
            e = 0; e < (a.colspan || 1); e++) {
    ...
    function loadData(a, b) {
        ...
        if (h.length) {
            ...
            i.total != b.total && (h.pagination("refresh", {
                ...
                total: b.total
            }), d.pageNumber != i.pageNumber && i.pageNumber > 0 && (d.pageNumber = i.pageNumber, request(a)))
        }
        fixRowHeight(a),
    ...
    function uncheckRow(a, b, c) {
        ...
        e = d.options,
        f = e.finder.getRow(a, b);
        if (f && 0 != e.onBeforeUncheck.apply(a, getArguments(a, [b, f]))) { ! c && e.selectOnCheck && unselectRow(a, b, !0);
    ...
    function checkAll(a, b) {
        var c = $.data(a, "datagrid"),
        d = c.options,
        e = d.finder.getRows(a); ! b && d.selectOnCheck && selectAll(a, !0);
        var f = c.dc,
    ...
    function uncheckAll(a, b) {
        var c = $.data(a, "datagrid"),
        d = c.options,
        e = d.finder.getRows(a); ! b && d.selectOnCheck && unselectAll(a, !0);
        var f = c.dc,
        g = f.header1.add(f.header2).find("input[type=checkbox]"),
    ...
    function initChanges(a) {
        for (var b = $.data(a, "datagrid"), c = b.data, d = c.rows, e = [], f = 0; f < d.length; f++) e.push($.extend({},
        d[f]));
        b.originalRows = e,
        b.updatedRows = [],
        b.insertedRows = [],
    ...
    var editors = $.extend({},
    getDefaultEditors(["text", "textbox", "passwordbox", "filebox", "numberbox", "numberspinner", "combobox", "combotree", "combogrid", "combotreegrid", "datebox", "datetimebox", "timespinner", "datetimespinner"]), {
        textarea: {
            init: function(a, b) {
    ...
    $.fn.datagrid.parseOptions = function(target) {
        var t = $(target);
        return $.extend({},
        $.fn.panel.parseOptions(target), $.parser.parseOptions(target, ["url", "toolbar", "idField", "sortName", "sortOrder", "pagePosition", "resizeHandle", {
    ...
    var defaultView = {
        ...
        renderEmptyRow: function(a) {
            var b = $.map($(a).datagrid("getColumnFields"),
            function(b) {
...
function(a) {
    ...
    function f(b) {
        ...
        c, {
            ...
            onAfterEdit: function(d, f) {
                ...
                if (g) {
                    for (var h = !1,
                    i = a(this).edatagrid("getColumnFields", !0).concat(a(this).edatagrid("getColumnFields")), j = 0; j < i.length; j++) {
                        var k = i[j],
                    ...
                    h ? c.poster.call(b, g, f,
                    function(e) {
                        if (e.isError) {
                            var g = c.originalRow;
                            return a(b).edatagrid("cancelRow", d),
                        ...
                        if (e.isNewRecord = null, a(b).datagrid("updateRow", {
                            ...
                            var h = f[c.idField || "id"],
                            i = a(c.tree),
                            j = i.tree("find", h);
                            if (j) j.text = f[c.treeTextField],
                            i.tree("update", j);
                            else {
        ...
        c.tree && a(c.tree).tree({
            ...
            onDrop: function(d, e, f) {
                ...
                c.poster.call(b, c.treeDndUrl, h,
                function(c) {
                    a(b).datagrid("load")
                })
            }
    ...
    var h = [];
    a(function() {
        a(document).unbind(".edatagrid").bind("mousedown.edatagrid",
        function(b) {
    ...
    a.fn.edatagrid = function(b, c) {
        ...
        this.each(function() {
            ...
            c ? a.extend(c.options, b) : a.data(this, "edatagrid", {
                options: a.extend({},
                a.fn.edatagrid.defaults, a.fn.edatagrid.parseOptions(this), b)
            }),
            f(this)
        })
    },
    ...
    a.fn.edatagrid.methods = {
        ...
        addRow: function(b, c) {
            return b.each(function() {
                ...
                "object" == typeof c ? b(c.index, a.extend(c.row, {
                    isNewRecord: !0
                })) : b(c, {
                    isNewRecord: !0
                }),
                d.datagrid("beginEdit", e.editIndex),
                d.datagrid("selectRow", e.editIndex);
            ...
            return b.each(function() {
                function b(b) {
                    ...
                    if (c != -1) if (b.isNewRecord) d.datagrid("cancelEdit", c);
                        ...
                        e.poster.call(d[0], e.destroyUrl, {
                            id: f
                        },
                        function(c) {
                ...
                return f.length ? void a.messager.confirm(e.destroyMsg.confirm.title, e.destroyMsg.confirm.msg,
                function(a) {
                    if (a) {
    ...
    a.fn.edatagrid.defaults = a.extend({},
...
function(a) {
    ...
    a.fn.propertygrid = function(c, d) {
        ...
        this.each(function() {
            ...
            if (d) a.extend(d.options, c);
                ...
                var e = a.extend({},
                a.fn.propertygrid.defaults, a.fn.propertygrid.parseOptions(this), c);
    ...
    a.fn.datagrid.defaults.view, {
        ...
        renderGroup: function(b, c, d, e) {
            ...
            for (var j = d.startIndex,
            k = 0; k < d.rows.length; k++) {
...
function(a) {
    ...
    function h(b, c, d, e) {
        ...
        if (g.checkbox) {
            ...
            if (h.checkState) {
                ...
                } else if (m.hasClass("tree-checkbox0")) return; (e || 0 != g.onBeforeCheckNode.call(b, h, d)) && (g.cascadeCheck ? (j(b, h, d), k(b, h)) : i(b, h, d ? "1": "0"), e || g.onCheckNode.call(b, h, d))
            }
        }
    }
    function i(b, c, d) {
    ...
    function v(b, c) {
        ...
        e = d.options,
        f = null;
        return a.easyui.forEach(d.data, !0,
        function(a) {
    ...
    a.fn.treegrid.methods = {
        ...
        reload: function(b, c) {
            return b.each(function() {
                ...
                d = {};
                if ("object" == typeof c ? d = c: (d = a.extend({},
                b.queryParams), d.id = c), d.id) {
        ...
        getCheckedNodes: function(b, c) {
            c = c || "checked";
            var d = [];
            return a.easyui.forEach(b.data("treegrid").checkedRows, !1,
            function(a) {
        ...
        clearChecked: function(b) {
            return b.each(function() {
                ...
                a.map(a(b).treegrid("getCheckedNodes"),
                function(a) {
                    h(b, a[c.idField], !1, !0)
                })
            })
    ...
    a.fn.datagrid.defaults, {
        ...
        view: G,
        rowEvents: a.extend({},
        a.fn.datagrid.defaults.rowEvents, {
            mouseover: e(!0),
            mouseout: e(!1),
            click: f
        }),
...
function(a) {
    ...
    a.fn.datalist = function(c, d) {
        ...
        this.each(function() {
            ...
            if (d) a.extend(d.options, c);
                ...
                var e = a.extend({},
                a.fn.datalist.defaults, a.fn.datalist.parseOptions(this), c);
                e.columns = a.extend(!0, [], e.columns),
    ...
    a.fn.datalist.parseOptions = function(b) {
        return a.extend({},
        a.fn.datagrid.parseOptions(b), a.parser.parseOptions(b, ["valueField", "textField", "groupField", {
            checkbox: "boolean",
            lines: "boolean"
        }]))
    },
    ...
    a.fn.datalist.defaults = a.extend({},
    a.fn.datagrid.defaults, {
        fitColumns: !0,
        singleSelect: !0,
        showHeader: !1,
...
function(a) {
    function b(b) {
        ...
        a(b).addClass("combo-f").textbox(a.extend({},
        f, {
            icons: g,
            onChange: function() {}
        })),
    ...
    a(function() {
        a(document).unbind(".combo").bind("mousedown.combo mousewheel.combo",
        function(b) {
    ...
    a.fn.combo = function(c, d) {
        ...
        this.each(function() {
            ...
            d ? (a.extend(d.options, c), void 0 != c.value && (d.options.originalValue = c.value)) : (d = a.data(this, "combo", {
                options: a.extend({},
                a.fn.combo.defaults, a.fn.combo.parseOptions(this), c),
                previousText: ""
    ...
    a.fn.combo.parseOptions = function(b) {
        var c = a(b);
        return a.extend({},
        a.fn.textbox.parseOptions(b), a.parser.parseOptions(b, ["separator", "panelAlign", {
            panelWidth: "number",
            hasDownArrow: "boolean",
            delay: "number",
            reversed: "boolean",
...
function(a) {
    ...
    function i(b, c, d, e) {
        ...
        d = a.extend({},
        f.queryParams, d || {}),
        0 != f.onBeforeLoad.call(b, d) && f.loader.call(b, d,
        function(a) {
            h(b, a, e)
        },
        function() {
    ...
    a.fn.combobox.parseOptions = function(b) {
        a(b);
        return a.extend({},
        a.fn.combo.parseOptions(b), a.parser.parseOptions(b, ["valueField", "textField", "groupField", "groupPosition", "mode", "method", "url", {
    ...
    a.fn.combo.defaults, {
        ...
        inputEvents: a.extend({},
        a.fn.combo.defaults.inputEvents, {
            blur: function(b) {
                var c = b.data.target,
                d = a(c).combobox("options"); (d.reversed || d.limitToList) && (d.blurTimer && clearTimeout(d.blurTimer), d.blurTimer = setTimeout(function() {
                    var b = a(c).parent().length;
                    if (b) {
                        if (d.reversed) a(c).combobox("setValues", a(c).combobox("getValues"));
                        else if (d.limitToList) {
                            var e = [];
                            a.map(a(c).combobox("getValues"),
                            function(b) {
...
function(a) {
    function b(b) {
        ...
        f, {
            ...
            onLoadSuccess: function(c, h) {
                ...
                f.multiple && a.map(g.tree("getChecked"),
                function(b) {
    ...
    function c(b) {
        ...
        f = c.tree,
        g = [];
        if (e.multiple) g = a.map(f.tree("getChecked"),
        function(a) {
            return a.id
        });
        else {
...
function(a) {
    function b(b) {
        ...
        function h() {
            ...
            f = a(e).data("combogrid"),
            g = f.options,
            h = a.map(b.datagrid("getSelections"),
            function(a) {
                return a[g.idField]
            });
        ...
        j = i.options,
        k = i.grid;
        a(b).addClass("combogrid-f").combo(a.extend({},
        j, {
            onShowPanel: function() {
    ...
    function d(b, c, d) {
        ...
        var p = a.grep(h.datagrid("getSelections"),
        function(b, c) {
    ...
    function e(b, c) {
        ...
        h.queryParams, {
            ...
            function(c) {
                ...
                var d = e(k, c);
                d >= 0 ? h.reversed && i.datagrid("highlightRow", d) : a.map(k,
                function(a, d) {
...
function(a) {
    function b(b) {
        ...
        f = e.options;
        if (a(b).addClass("combotreegrid-f").combo(a.extend({},
        f, {
            onShowPanel: function() {
        ...
        e.grid.treegrid(a.extend({},
        f, {
            border: !1,
            checkbox: f.multiple,
            onLoadSuccess: function(c, g) {
                var h = a(b).combotreegrid("getValues");
                f.multiple && a.map(a(this).treegrid("getCheckedNodes"),
                function(b) {
    ...
    function c(b) {
        ...
        f = c.grid,
        g = [];
        if (e.multiple) g = a.map(f.treegrid("getCheckedNodes"),
        function(a) {
            return a[e.idField]
        });
        else {
    ...
    function d(b, c) {
        ...
        }), g.multiple && a.map(h.treegrid("getCheckedNodes"),
        function(b) {
        ...
        f.queryParams, {
            ...
            function(c) {
                if (c = a.trim(c)) {
                    ...
                    void 0 == d && a.easyui.forEach(f.mappingRows, !1,
                    function(a) {
    ...
    a.fn.combotreegrid = function(c, d) {
        ...
        this.each(function() {
            ...
            d ? a.extend(d.options, c) : d = a.data(this, "combotreegrid", {
                options: a.extend({},
                a.fn.combotreegrid.defaults, a.fn.combotreegrid.parseOptions(this), c)
            }),
            b(this)
        })
    },
    ...
    a.fn.combotreegrid.parseOptions = function(b) {
        a(b);
        return a.extend({},
        a.fn.combo.parseOptions(b), a.fn.treegrid.parseOptions(b), a.parser.parseOptions(b, ["mode", {
            limitToGrid: "boolean"
        }]))
    },
    a.fn.combotreegrid.defaults = a.extend({},
    a.fn.combo.defaults, a.fn.treegrid.defaults, {
        editable: !1,
        singleSelect: !0,
        limitToGrid: !1,
        unselectedValues: [],
...
function(a) {
    function b(b) {
        ...
        g = f.options;
        a(b).addClass("tagbox-f").combobox(a.extend({},
        g, {
            cls: "tagbox",
            reversed: !0,
    ...
    function d(b) {
        var c = a(b).next();
        c.unbind(".tagbox").bind("click.tagbox",
        function(c) {
    ...
    a.fn.tagbox = function(c, e) {
        ...
        this.each(function() {
            ...
            e ? a.extend(e.options, c) : a.data(this, "tagbox", {
                options: a.extend({},
                a.fn.tagbox.defaults, a.fn.tagbox.parseOptions(this), c)
            }),
            b(this),
            d(this)
        })
    ...
    a.fn.tagbox.parseOptions = function(b) {
        return a.extend({},
        a.fn.combobox.parseOptions(b), a.parser.parseOptions(b, []))
    },
    a.fn.tagbox.defaults = a.extend({},
    a.fn.combobox.defaults, {
        ...
        tipOptions: a.extend({},
        a.fn.textbox.defaults.tipOptions, {
            showDelay: 200
        }),
        val: function(b) {
        ...
        keyHandler: a.extend({},
        a.fn.combobox.defaults.keyHandler, {
            enter: function(a) {
                f(this)
            },
            query: function(b, c) {
...
function(a) {
    function b(b) {
        function c(b) {
            ...
            d = a(b).combo("panel");
            d.unbind(".datebox").bind("click.datebox",
            function(d) {
        ...
        h = g.options;
        if (a(b).addClass("datebox-f").combo(a.extend({},
        h, {
            onShowPanel: function() {
                c(this),
                d(this),
...
function(a) {
    ...
    a.fn.datetimebox.parseOptions = function(b) {
        a(b);
        return a.extend({},
        a.fn.datebox.parseOptions(b), a.parser.parseOptions(b, ["timeSeparator", "spinnerWidth", {
            showSeconds: "boolean"
        }]))
    },
...
function($) {
    ...
    function buildSlider(a) {
        ...
        e.find("div.slider-inner").unbind(".slider").bind("mousedown.slider",
        function(e) {
    ...
    function setValues(a, b) {
        ...
        g = [];
        $.isArray(b) || (b = $.map(String(b).split(d.separator),
        function(a) {
            return parseFloat(a)
        })),
    ...
    $.fn.slider = function(a, b) {
        ...
        this.each(function() {
            ...
            c.range ? ($.isArray(c.value) || (c.value = $.map(String(c.value).split(c.separator),
            function(a) {
                return parseFloat(a)
    ...
    $.fn.slider.parseOptions = function(target) {
        var t = $(target);
        return $.extend({},
        $.parser.parseOptions(target, ["width", "height", "mode", {
            reversed: "boolean",
            showTip: "boolean",
            range: "boolean",
            min: "number",
...
String.prototype.cutStr2Arr = function(a) {
    for (var b = this,
    c = [], d = Math.ceil(b.length / a), e = 0; e < d; e++) if (b.length >= a) {
...
function(a) {
    ...
    a.extend({
        _m5: function(a) {
            ...
            H = 15,
            I = 21;
            for (a = n(a), s = l(a), o = 1732584193, p = 4023233417, q = 2562383102, r = 271733878, b = 0; b < s.length; b += 16) d = o,
            e = p,
            f = q,
            g = r,
            o = h(o, p, q, r, s[b + 0], t, 3614090360),
            r = h(r, o, p, q, s[b + 1], u, 3905402710),
            q = h(q, r, o, p, s[b + 2], v, 606105819),
            p = h(p, q, r, o, s[b + 3], w, 3250441966),
            o = h(o, p, q, r, s[b + 4], t, 4118548399),
            r = h(r, o, p, q, s[b + 5], u, 1200080426),
            q = h(q, r, o, p, s[b + 6], v, 2821735955),
            p = h(p, q, r, o, s[b + 7], w, 4249261313),
            o = h(o, p, q, r, s[b + 8], t, 1770035416),
            r = h(r, o, p, q, s[b + 9], u, 2336552879),
            q = h(q, r, o, p, s[b + 10], v, 4294925233),
            p = h(p, q, r, o, s[b + 11], w, 2304563134),
            o = h(o, p, q, r, s[b + 12], t, 1804603682),
            r = h(r, o, p, q, s[b + 13], u, 4254626195),
            q = h(q, r, o, p, s[b + 14], v, 2792965006),
            p = h(p, q, r, o, s[b + 15], w, 1236535329),
            o = i(o, p, q, r, s[b + 1], x, 4129170786),
            r = i(r, o, p, q, s[b + 6], y, 3225465664),
            q = i(q, r, o, p, s[b + 11], z, 643717713),
            p = i(p, q, r, o, s[b + 0], A, 3921069994),
            o = i(o, p, q, r, s[b + 5], x, 3593408605),
            r = i(r, o, p, q, s[b + 10], y, 38016083),
            q = i(q, r, o, p, s[b + 15], z, 3634488961),
            p = i(p, q, r, o, s[b + 4], A, 3889429448),
            o = i(o, p, q, r, s[b + 9], x, 568446438),
            r = i(r, o, p, q, s[b + 14], y, 3275163606),
            q = i(q, r, o, p, s[b + 3], z, 4107603335),
            p = i(p, q, r, o, s[b + 8], A, 1163531501),
            o = i(o, p, q, r, s[b + 13], x, 2850285829),
            r = i(r, o, p, q, s[b + 2], y, 4243563512),
            q = i(q, r, o, p, s[b + 7], z, 1735328473),
            p = i(p, q, r, o, s[b + 12], A, 2368359562),
            o = j(o, p, q, r, s[b + 5], B, 4294588738),
            r = j(r, o, p, q, s[b + 8], C, 2272392833),
            q = j(q, r, o, p, s[b + 11], D, 1839030562),
            p = j(p, q, r, o, s[b + 14], E, 4259657740),
            o = j(o, p, q, r, s[b + 1], B, 2763975236),
            r = j(r, o, p, q, s[b + 4], C, 1272893353),
            q = j(q, r, o, p, s[b + 7], D, 4139469664),
            p = j(p, q, r, o, s[b + 10], E, 3200236656),
            o = j(o, p, q, r, s[b + 13], B, 681279174),
            r = j(r, o, p, q, s[b + 0], C, 3936430074),
            q = j(q, r, o, p, s[b + 3], D, 3572445317),
            p = j(p, q, r, o, s[b + 6], E, 76029189),
            o = j(o, p, q, r, s[b + 9], B, 3654602809),
            r = j(r, o, p, q, s[b + 12], C, 3873151461),
            q = j(q, r, o, p, s[b + 15], D, 530742520),
            p = j(p, q, r, o, s[b + 2], E, 3299628645),
            o = k(o, p, q, r, s[b + 0], F, 4096336452),
            r = k(r, o, p, q, s[b + 7], G, 1126891415),
            q = k(q, r, o, p, s[b + 14], H, 2878612391),
            p = k(p, q, r, o, s[b + 5], I, 4237533241),
            o = k(o, p, q, r, s[b + 12], F, 1700485571),
            r = k(r, o, p, q, s[b + 3], G, 2399980690),
            q = k(q, r, o, p, s[b + 10], H, 4293915773),
            p = k(p, q, r, o, s[b + 1], I, 2240044497),
            o = k(o, p, q, r, s[b + 8], F, 1873313359),
            r = k(r, o, p, q, s[b + 15], G, 4264355552),
            q = k(q, r, o, p, s[b + 6], H, 2734768916),
            p = k(p, q, r, o, s[b + 13], I, 1309151649),
            o = k(o, p, q, r, s[b + 4], F, 4149444226),
            r = k(r, o, p, q, s[b + 11], G, 3174756917),
            q = k(q, r, o, p, s[b + 2], H, 718787259),
            p = k(p, q, r, o, s[b + 9], I, 3951481745),
            o = c(o, d),
            p = c(p, e),
            q = c(q, f),
            r = c(r, g);
...
jQuery.b = function(a) {
    function b(a) {
        var b, c, d, e, f, h, j, k = "",
        l = 0;
        for (a = g(a); l < a.length;) b = a.charCodeAt(l++),
        c = a.charCodeAt(l++),
        d = a.charCodeAt(l++),
        e = b >> 2,
        f = (3 & b) << 4 | c >> 4,
        h = (15 & c) << 2 | d >> 6,
        j = 63 & d,
        isNaN(c) ? h = j = 64 : isNaN(d) && (j = 64),
        k = k + i.charAt(e) + i.charAt(f) + i.charAt(h) + i.charAt(j);
        return k
    }
    function c(a) {
        var b, c, d, e, f, g, j, k = "",
        l = 0;
        for (a = a.replace(/[^A-Za-z0-9\+\/\=]/g, ""); l < a.length;) e = i.indexOf(a.charAt(l++)),
        f = i.indexOf(a.charAt(l++)),
        g = i.indexOf(a.charAt(l++)),
        j = i.indexOf(a.charAt(l++)),
        b = e << 2 | f >> 4,
        c = (15 & f) << 4 | g >> 2,
        d = (3 & g) << 6 | j,
        k += String.fromCharCode(b),
        64 != g && (k += String.fromCharCode(c)),
        64 != j && (k += String.fromCharCode(d));
        return k = h(k)
    }
    function d() {
        a.map(["textbox", "combobox", "datebox"],
        function(b) {
            a.fn[b] && (a.fn[b].defaults = {})
        })
    }
    function e(a) {
        for (var b = "",
        c = 0; c < a.length; c++) b += a.split("")[c] + a.split("")[a.length - c - 1];
        return b
    }
    function f() {
        var b = window[a.b.dc("dG9wSlVJ")][a.b.dc("bA==")];
        arrayContain(b.substr(32).cutStr2Arr(40), a._s1(a._m5(a.b.cf(_tjp.split("/")[2].split(":")[0] + b.substr(0, 32))))) || a.b.tj()
    }
    function g(a) {
        a = a.replace(/\r\n/g, "\n");
        for (var b = "",
...
function(a) {
    ...
    function l(d, e) {
        ...
        function j(b, c) {
            ...
            return a.map(["nofilter"].concat(c),
            function(b) {
                var c = o.operators[b];
    ...
    a.extend(a.fn.treegrid.methods, {
        ...
        insert: function(b, c) {
            return b.each(function() {
                function b(a) {
                    for (var b = d.filterSource.rows,
                    c = 0; c < b.length; c++) if (b[c][e.idField] == a) return c;
                    return - 1
                }
        ...
        remove: function(b, c) {
            return b.each(function() {
                var b = a(this).data("treegrid");
                if (b.filterSource) for (var d = b.options,
                e = b.filterSource.rows,
                f = 0; f < e.length; f++) if (e[f][d.idField] == c) {
                    e.splice(f, 1),
                    b.filterSource.total--;
                    break
                }
    ...
    var u = {
        ...
        defaultFilterOptions: {
            onInit: function(c) {
                ...
                h.unbind(".filter").bind("keydown.filter",
                function(b) {
                    a(this);
    ...
    a.fn.datagrid.defaults.filters = a.extend({},
    a.fn.datagrid.defaults.editors, {
        label: {
            init: function(b, c) {
    ...
    a.extend(a.fn.datagrid.methods, {
        ...
        disableFilter: function(c) {
            return c.each(function() {
                ...
                var i = d.data;
                d.filterSource && (i = d.filterSource, a.map(i.rows,
                function(a) {
                    a.children = void 0
                })),
                a(this)[c]({
...
function(a) {
    ...
    a.fn.iAccordion.parseOptions = function(b, c) {
        var d = a.extend({},
        a.fn.accordion.parseOptions(b), a.fn.iAccordion.defaults, a.parser.parseOptions(b, ["id"]), c);
        return setId(b, d)
    },
...
function(a) {
    ...
    a.fn.iAutocomplete.parseOptions = function(b, c) {
        var d = a.extend({},
        a.fn.combobox.parseOptions(b), a.fn.iAutocomplete.defaults, a.parser.parseOptions(b, ["id"]), c);
        return setId(b, d)
    },
...
function(a) {
    ...
    a.fn.iCalendar.parseOptions = function(b, c) {
        var d = a.extend({},
        a.fn.calendar.parseOptions(b), a.fn.iCalendar.defaults, a.parser.parseOptions(b, ["id"]), c);
        return setId(b, d)
    },
...
function(a) {
    ...
    var d = {
        checkbox: {
            cursor: "pointer",
            background: "transparent url('" + _tjp + "images/checkbox.png') no-repeat -32px 0",
    ...
    a.fn.iCheckbox = function(c, d) {
        return "string" == typeof c ? a.fn.iCheckbox.methods[c](this, d) : (c = c || {},
        this.each(function() {
    ...
    a.fn.iCheckbox.methods = {
        ...
        check: function(b, d) {
            d && "object" != typeof d ? c(b, d) : d.sort && a.each(d,
            function() {
                c(b, this)
            })
        },
        unCheck: function(b, d) {
            d && "object" != typeof d ? c(b, d, !0) : d.sort && a.each(d,
            function() {
                c(b, this, !0)
            })
        },
    ...
    a.parser && a.parser.plugins && a.parser.plugins.push("checkbox")
} (jQuery),
function(a) {
    ...
    a.fn.iCombo.parseOptions = function(b, c) {
        var d = a.extend({},
        a.fn.combo.parseOptions(b), a.fn.iCombo.defaults, a.parser.parseOptions(b, ["id"]), c);
        return setId(b, d)
    },
...
function(a) {
    ...
    a.fn.iCombobox.parseOptions = function(b, c) {
        var d = a.extend({},
        a.fn.combobox.parseOptions(b), a.fn.iCombobox.defaults, a.parser.parseOptions(b, ["id"]), c);
        return setId(b, d)
    },
...
function(a) {
    ...
    a.fn.iCombogrid.parseOptions = function(b, c) {
        var d = a.extend({},
        a.fn.combogrid.parseOptions(b), a.fn.iCombogrid.defaults, a.parser.parseOptions(b, ["id"]), c);
        return setId(b, d)
    },
...
function(a) {
    ...
    a.fn.iCombotree.parseOptions = function(b, c) {
        var d = a.extend({},
        a.fn.combotree.parseOptions(b), a.fn.iCombotree.defaults, a.parser.parseOptions(b, ["id"]), c);
        return setId(b, d)
    },
    a.fn.iCombotree.defaults = {
        ...
        onSelect: function(b) {
            ...
            "object" == typeof c.backfill && a.getJSON(replaceUrlParamValueByBrace(c.backfill.url, b), {},
            function(b) {
...
function(a) {
    ...
    a.fn.iCombotreegrid.parseOptions = function(b, c) {
        var d = a.extend({},
        a.fn.combotreegrid.parseOptions(b), a.fn.iCombotreegrid.defaults, a.parser.parseOptions(b, ["id"]), c);
        return setId(b, d)
    },
    a.fn.iCombotreegrid.defaults = {
        ...
        onLoadSuccess: function(b, c) {
            ...
            d.expandAll && e.iCombotreegrid("expandAll"),
...
var openDialog = function(a) {
    ...
    if ("object" == typeof d) openDialogAndloadDataByParentGrid(b);
        ...
        if ("undefined" != c.onBeforeOpen && executeCallBackFun(c.onBeforeOpen, b), "object" == typeof b.grid) {
            var e = b.grid.unselectedMsg || b.grid.uncheckedMsg;
            if (void 0 != e) {
                var f = getSelectedRowsData(b.grid.type, b.grid.id);
                if (0 == f.length) return void topjuiAlert(e)
            }
        }
        if (topJUI.config.appendRefererParam && (b.dialog.href = appendSourceUrlParam(b.dialog.href)), b.dialog.href.indexOf("{") != -1) {
            var g = b.grid.unselectedMsg || b.grid.uncheckedMsg,
            f = getSelectedRowsData(b.grid.type, b.grid.id);
            if (!f[0]) return void topjuiAlert(g || topJUI.language.message.msg.unSelect);
            if (1 != f.length) return void topjuiAlert(topJUI.language.message.msg.singleSelect);
            $("#" + b.dialog.id).iDialog("createDialog", b.dialog);
            var h = $("#" + c.id);
            h.iDialog(b.dialog);
            var i = replaceUrlParamValueByBrace(b.dialog.href, f[0]);
            h.iDialog({
                href: i
            }),
            h.iDialog("open")
...
function(a) {
    ...
    a.fn.iDatagrid = function(b, c) {
        ...
        this.each(function() {
            if (b = a.fn.iDatagrid.parseOptions(this, b), topJUI.config.appendRefererParam && (b.url = appendSourceUrlParam(b.url)), b.initCreate) {
                if (!b.columns) {
    ...
    a.fn.iDatagrid.methods = {
        ...
        singleSelectedAjax: function(b, c) {
            ...
            return null == d ? void unselectedAlert(c) : (c.url = replaceUrlParamValueByBrace(c.url, d), void a.messager.confirm(topJUI.language.message.title.confirmTips, c.confirmMsg,
            function(a) {
                if (a) {
                    var b = doAjax(c);
        ...
        multiSelectedAjax: function(b, c) {
            ...
            return 0 == d.length ? void unselectedAlert(c) : void a.messager.confirm(topJUI.language.message.title.confirmTips, c.confirmMsg,
            function(a) {
                if (a) {
                    var b;
        ...
        multiCheckedAjax: function(b, c) {
            var d = getCheckedRowsData(c.grid.type, c.grid.id);
            return 0 == d.length ? void uncheckedAlert(c) : void a.messager.confirm(topJUI.language.message.title.confirmTips, c.confirmMsg,
            function(a) {
                if (a) {
    ...
    a.fn.iDatagrid.parseOptions = function(b, c) {
        var c = a.extend({},
        a.parser.parseOptions(b, ["id"]), c);
        if (!c.toolbar) {
            var d = "" == b.id ? c.id: b.id;
            c.toolbar = "#" + d + "-toolbar"
        }
        var e = a.extend({},
        a.fn.datagrid.parseOptions(b), a.fn.iDatagrid.defaults, c);
        return setId(b, e)
    },
    a.fn.iDatagrid.defaults = {
        ...
        onLoadSuccess: function() {
            ...
            if (a(this).iDatagrid("doCellTip", {
                cls: {},
                delay: 500
            }), a(this).iDatagrid("fixRownumber"), "object" == typeof b.childGrid) for (var c = b.childGrid.grid,
            d = 0; d < c.length; d++) {
        ...
        onClickRow: function(b, c) {
                ...
                function(b) {
                    setTimeout(function() {
                        ...
                        if ("datagrid" == f[b].type) {
                            ...
                            c.datagrid("options").queryParams = a.extend({},
                            d, e),
                            c.datagrid("load")
                        } else if ("treegrid" == f[b].type) {
                            var d = c.treegrid("options").queryParams;
                            c.treegrid("options").queryParams = a.extend({},
                            d, e),
                            c.treegrid("load")
            ...
            if ("object" == typeof d.childTab) for (var h = d.childTab,
            g = 0; g < h.length; g++) {
                var i = a("#" + h[g].id),
                j = i.tabs("options"),
...
function(a) {
    ...
    a.fn.iDatebox.parseOptions = function(b, c) {
        var d = a.extend({},
        a.fn.datebox.parseOptions(b), a.fn.iDatebox.defaults, a.parser.parseOptions(b, ["id"]), c);
        return setId(b, d)
    },
...
function(a) {
    ...
    a.fn.iDatetimebox.parseOptions = function(b, c) {
        var d = a.extend({},
        a.fn.datetimebox.parseOptions(b), a.fn.iDatetimebox.defaults, a.parser.parseOptions(b, ["id"]), c);
        return setId(b, d)
    },
...
function(a) {
    ...
    a.fn.iDatetimespinner.parseOptions = function(b, c) {
        var d = a.extend({},
        a.fn.datetimespinner.parseOptions(b), a.fn.iDatetimespinner.defaults, a.parser.parseOptions(b, ["id"]), c);
        return setId(b, d)
    },
...
function(a) {
    a.fn.iDialog = function(b, c) {
        ...
        this.each(function() {
            ...
            topJUI.config.appendRefererParam && b.href && (b.href = appendSourceUrlParam(b.href)),
    ...
    a.fn.iDialog.parseOptions = function(b, c) {
        var d = a.extend({},
        a.fn.dialog.parseOptions(b), a.fn.iDialog.defaults, a.parser.parseOptions(b, ["id"]), c);
        return setId(b, d)
    },
...
function(a) {
    ...
    a.fn.iEcharts.parseOptions = function(b, c) {
        var d = a.extend({},
        a.fn.iEcharts.defaults, a.parser.parseOptions(b, ["id"]), c);
        return setId(b, d)
    },
    a.fn.iEcharts.defaults = {},
    a.parser && a.parser.plugins && a.parser.plugins.push("echarts")
} (jQuery),
function(a) {
    ...
    a.fn.iEdatagrid.parseOptions = function(b, c) {
        ...
        var e = a.extend({},
        a.fn.edatagrid.parseOptions(b), a.fn.iDatagrid.defaults, a.fn.iEdatagrid.defaults, c);
        return setId(b, e)
    },
    a.fn.iEdatagrid.defaults = {
        ...
        onBeforeLoad: function(a) {},
        onLoadSuccess: function() {
            a(this).iDatagrid("doCellTip", {
                cls: {},
                delay: 500
            }),
            a(this).iDatagrid("fixRownumber")
        },
        onClickRow: function(b, c) {
...
function(a) {
    ...
    a.fn.iFilebox.parseOptions = function(b, c) {
        var d = a.extend({},
        a.fn.filebox.parseOptions(b), a.fn.iFilebox.defaults, a.parser.parseOptions(b, ["id"]), c);
        return setId(b, d)
    },
...
function(a) {
    ...
    a.fn.iForm.parseOptions = function(b, c) {
        var d = a.extend({},
        a.fn.form.parseOptions(b), a.fn.iForm.defaults, a.parser.parseOptions(b, ["id"]), c);
        return setId(b, d)
    },
    a.fn.iForm.defaults = {}
} (jQuery),
function(a) {
    a.fn.iLayout = function(b, c) {
        ...
        this.each(function() {
            ...
            var c = window[a.b.dc("dG9wSlVJ")][a.b.dc("bA==")];
            arrayContain(c.substr(32).cutStr2Arr(40), a._s1(a._m5(a.b.cf(_tjp.split("/")[2].split(":")[0] + c.substr(0, 32))))) && a(this).layout(b)
        })
    },
    a.fn.iLayout.methods = {},
    a.fn.iLayout.parseOptions = function(b, c) {
        var d = a.extend({},
        a.fn.layout.parseOptions(b), a.fn.iLayout.defaults, a.parser.parseOptions(b, ["id"]), c);
        return setId(b, d)
    },
    a.fn.iLayout.defaults = {}
} (jQuery),
function($) {
    $.fn.iLinkbutton = function(a, b) {
        if ("string" == typeof a) {
            var c = $.fn.iLinkbutton.methods[a];
            return c ? c(this, b) : this.linkbutton(a, b)
        }
        this.each(function() {
            a = $.fn.iLinkbutton.parseOptions(this, a),
            a.text = "" == a.text ? $(this).text() : a.text,
            $(this).linkbutton(a)
        })
    },
    $.fn.iLinkbutton.methods = {},
    $.fn.iLinkbutton.parseOptions = function(a, b) {
        var c = $.extend({},
        $.fn.linkbutton.parseOptions(a), $.fn.iLinkbutton.defaults, $.parser.parseOptions(a, ["id"]), b);
        return setId(a, c)
    },
    $.fn.iLinkbutton.defaults = {
        iconCls: "fa fa-cog",
        btnCls: "topjui-btn-green",
        onClick: function() {
            var opts = $(this).iLinkbutton("options");
            if ("object" == typeof opts.form) {
                var form = opts.form;
                "submit" == form.method ? $("#" + form.id).form("submit", {
                    url: form.url,
                    onSubmit: function() {
                        var a = $(this).form("validate");
                        return a || $.messager.progress("close"),
                        a
                    },
                    success: function(a) {
                        var a = strToJson(a);
                        if (a.statusCode == topJUI.config.statusCode.success) {
                            $.messager.progress("close");
                            var b = parent.$("#index_tabs"),
                            c = getSelectedTabOpts(b);
                            if (opts.form.refreshCurrentTab) {
                                var d = parent.$("#" + c.id),
                                e = d.find("iframe")[0];
                                e.contentWindow.location.href = e.src
                            }
                            if (opts.form.refreshRefererTab) {
                                var d = parent.$("#" + c.refererTab.id),
                                e = d.find("iframe")[0];
                                e.contentWindow.location.href = e.src
                            }
                            if (opts.form.closeCurrentTab) {
                                var f = b.tabs("getSelected"),
                                g = b.tabs("getTabIndex", f);
                                b.tabs("close", g)
                            }
                        }
                    }
                }) : "reset" == form.method ? $("#" + form.id).form("reset") : "clear" == form.method && $("#" + form.id).form("clear")
            }
            var defaultHandler = ["ajaxForm", "multiAjaxForm"];
            if (arrayContain(defaultHandler, opts.handler)) {
                if ("ajaxForm" == opts.handler || "multiAjaxForm" == opts.handler) {
                    "undefined" != opts.handlerBefore && executeCallBackFun(opts.handlerBefore);
                    var mbOpts = $("#" + opts.mbId).menubutton("options"),
                    gridOpts = mbOpts.grid,
                    dialogOptions = mbOpts.dialog;
                    if ($("#" + opts.dialogId).form("validate")) {
                        if (opts.ajaxData = $("#" + opts.dialogId).serialize(), "multiAjaxForm" == opts.handler) {
                            var rows = getCheckedRowsData(gridOpts.type, gridOpts.id);
                            void 0 == gridOpts.param && (gridOpts.param = topJUI.config.pkName + ":" + topJUI.config.pkName),
                            opts.ajaxData += "&" + convertParamObj2Serialize(param2JsonObj(gridOpts.param), rows)
                        }
                        var result = doAjax(opts);
                        if (result.statusCode == topJUI.config.statusCode.success) {
                            if ($("#" + opts.dialogId).dialog("close"), "object" == typeof gridOpts) if ("datagrid" == gridOpts.type) $("#" + gridOpts.id).datagrid("reload");
                            else if ("treegrid" == gridOpts.type) {
                                var row = getSelectedRowData(gridOpts.type, gridOpts.id);
                                null == row ? $("#" + gridOpts.id).treegrid("reload") : $("#" + gridOpts.id).treegrid("reload", row[gridOpts.parentIdField])
                            }
                            refreshGrids(opts.reload)
                        }
                        showMessage(result)
                    }
                }
            } else void 0 != opts.handler && eval(opts.handler + "()")
        }
    }
} (jQuery),
function(a) {
    ...
    a.fn.iMenu.parseOptions = function(b, c) {
        var d = a.extend({},
        a.fn.menu.parseOptions(b), a.fn.iMenu.defaults, a.parser.parseOptions(b, ["id"]), c);
        return setId(b, d)
    },
    a.fn.iMenu.defaults = {}
} (jQuery),
function(a) {
    ...
    a.fn.iMenubutton.parseOptions = function(b, c) {
        var d = a.extend({},
        a.fn.menubutton.parseOptions(b), a.fn.iMenubutton.defaults, a.parser.parseOptions(b, ["id"]), c);
        return setId(b, d)
    },
...
function(a) {
    ...
    a.fn.iMessager.parseOptions = function(b, c) {
        return a.extend({},
        a.fn.messager.parseOptions(b), a.fn.iMessager.defaults, a.parser.parseOptions(b), setId(b, c))
    },
...
function(a) {
    ...
    a.fn.iNumberbox.parseOptions = function(b, c) {
        var d = a.extend({},
        a.fn.numberbox.parseOptions(b), a.fn.iNumberbox.defaults, a.parser.parseOptions(b, ["id"]), c);
        return setId(b, d)
    },
...
function(a) {
    ...
    a.fn.iNumberspinner.parseOptions = function(b, c) {
        var d = a.extend({},
        a.fn.numberspinner.parseOptions(b), a.fn.iNumberspinner.defaults, a.parser.parseOptions(b, ["id"]), c);
        return setId(b, d)
    },
...
function(a) {
    ...
    a.fn.iPanel.parseOptions = function(b, c) {
        var d = a.extend({},
        a.fn.panel.parseOptions(b), a.fn.iPanel.defaults, a.parser.parseOptions(b, ["id"]), c);
        return setId(b, d)
    },
...
function(a) {
    ...
    a.fn.iPasswordbox.parseOptions = function(b, c) {
        var d = a.extend({},
        a.fn.passwordbox.parseOptions(b), a.fn.iPasswordbox.defaults, a.parser.parseOptions(b, ["id"]), c);
        return setId(b, d)
    },
...
function(a) {
    "use strict";
    a(document).on(topJUI.eventType.initUI.base,
    function(a, b) {}),
    a(document).on(topJUI.eventType.initUI.advanceSearchForm,
    function(b, c) {
    	//laowu 20180226
    	if(a.cookie("fieldNameStr"))
    	{
        ...
        a(".deleteCondition:last").on("click",
        function() {
            var b = a(".deleteCondition").index(this) + 2;
            a("#advanceSearchTable tr:eq(" + b + ")").remove()
        })
    }),
    a(document).on(topJUI.eventType.initUI.importExcelForm,
    function(b, c) {
        setTimeout(function() {
...
$(function() {
    ...
    1e3),
    $("#submitImportExcelForm").on("click",
    function() {
...
"undefined" == typeof $.b ? c() : "function" == typeof $.b.a ? $.b.a() : c(),
function(a) {
    ...
    a.fn.iProgressbar.parseOptions = function(b, c) {
        var d = a.extend({},
        a.fn.progressbar.parseOptions(b), a.fn.iProgressbar.defaults, a.parser.parseOptions(b, ["id", "value"]), c);
        return setId(b, d)
    },
...
function(a) {
    ...
    var c = {
        radio: {
            cursor: "pointer",
            background: "transparent url('" + _tjp + "images/radiobox.png') no-repeat -32px 0",
            verticalAlign: "middle",
            height: "16px",
            width: "16px",
            display: "block"
    ...
    a.fn.iRadio = function(c, d) {
        return "string" == typeof c ? a.fn.iRadio.methods[c](this, d) : (c = c || {},
        this.each(function() {
    ...
    a.parser && a.parser.plugins && a.parser.plugins.push("radio")
} (jQuery),
function(a) {
    ...
    a.fn.iSearchbox.parseOptions = function(b, c) {
        var d = a.extend({},
        a.fn.searchbox.parseOptions(b), a.fn.iSearchbox.defaults, a.parser.parseOptions(b, ["id"]), c);
        return setId(b, d)
    },
...
function(a) {
    ...
    a.fn.iSlider.parseOptions = function(b, c) {
        var d = a.extend({},
        a.fn.slider.parseOptions(b), a.fn.iSlider.defaults, a.parser.parseOptions(b, ["id"]), c);
        return setId(b, d)
    },
...
function(a) {
    ...
    a.fn.iSpinner.parseOptions = function(b, c) {
        var d = a.extend({},
        a.fn.spinner.parseOptions(b), a.fn.iSpinner.defaults, a.parser.parseOptions(b, ["id"]), c);
        return setId(b, d)
    },
...
function(a) {
    ...
    a.fn.iSplitbutton.parseOptions = function(b, c) {
        var d = a.extend({},
        a.fn.splitbutton.parseOptions(b), a.fn.iSplitbutton.defaults, a.parser.parseOptions(b, ["id"]), c);
        return setId(b, d)
    },
...
function(a) {
    ...
    a.fn.iSwitchbutton.parseOptions = function(b, c) {
        var d = a.extend({},
        a.fn.switchbutton.parseOptions(b), a.fn.iSwitchbutton.defaults, a.parser.parseOptions(b, ["id"]), c);
        return setId(b, d)
    },
...
function(a) {
    ...
    a.fn.iTabs.methods = {
        ...
        bindDblclick: function(b, c) {
            return b.each(function() {
                var b = this;
                a(this).children("div.tabs-header").find("ul.tabs").undelegate("li", "dblclick.tabs").delegate("li", "dblclick.tabs",
                function(d) {
    ...
    a.fn.iTabs.parseOptions = function(b, c) {
        var d = a.extend({},
        a.fn.tabs.parseOptions(b), a.fn.iTabs.defaults, a.parser.parseOptions(b, ["id"]), c);
        return setId(b, d)
    },
    a.fn.iTabs.defaults = {
        refererTab: "",
        ...
        onSelect: function(b, c) {
            ...
            if (null != g.href || null != g.iframeHref) {
                ...
                i.length > 0 ? a("#" + g.id).children('[data-toggle="topjui-datagrid"]').each(function(b) {
                    var c = (a(this), a.parser.parseOptions(this)),
                    d = c.url;
                    c.url = "",
                    c.initCreate = !0,
                    a(this).iDatagrid(c);
                    a("#" + c.id);
                    "object" == typeof e && setGridQueryParams(e, "datagrid", c.id),
                    a(this).iDatagrid("options").url = d,
...
function(a) {
    ...
    a.fn.iTagbox.parseOptions = function(b, c) {
        var d = a.extend({},
        a.fn.tagbox.parseOptions(b), a.fn.iTagbox.defaults, a.parser.parseOptions(b, ["id", "label", "value"]), c);
        return setId(b, d)
    },
...
function(a) {
    ...
    a.fn.iTextarea.parseOptions = function(b, c) {
        var d = a.extend({},
        a.fn.textbox.parseOptions(b), a.fn.iTextarea.defaults, a.parser.parseOptions(b, ["id", "value"]), c);
        return setId(b, d)
    },
...
function(a) {
    ...
    a.fn.iTextbox.parseOptions = function(b, c) {
        var d = a.extend({},
        a.fn.textbox.parseOptions(b), a.fn.iTextbox.defaults, a.parser.parseOptions(b, ["id", "value"]), c);
        return setId(b, d)
    },
...
function(a) {
    ...
    a.fn.iTimeaxis.parseOptions = function(b, c) {
        var d = a.extend({},
        a.fn.iTimeaxis.defaults, a.parser.parseOptions(b, ["id"]), c);
        return setId(b, d)
    },
    a.fn.iTimeaxis.defaults = {},
    a.parser && a.parser.plugins && a.parser.plugins.push("timeaxis")
} (jQuery),
function(a) {
    ...
    a.fn.iTimespinner.parseOptions = function(b, c) {
        var d = a.extend({},
        a.fn.timespinner.parseOptions(b), a.fn.iTimespinner.defaults, a.parser.parseOptions(b, ["id"]), c);
        return setId(b, d)
    },
...
function(a) {
    ...
    a.fn.iTree.parseOptions = function(b, c) {
        var d = a.extend({},
        a.fn.tree.parseOptions(b), a.fn.iTree.defaults, a.parser.parseOptions(b, ["id"]), c);
        return setId(b, d)
    },
    a.fn.iTree.defaults = {
        id: this.selector,
...
function(a) {
    ...
    a.fn.iTreegrid.methods = {
        cascadeCheck: function(b, c) {
            ...
            function e(b, c, d, f, g) { ! g && f && a(b).treegrid("expand", c);
            ...
            if (!f.singleSelect) {
                for (var g = f.idField,
                h = !1,
                i = a(b.selector).treegrid("getSelections"), j = 0; j < i.length; j++) i[j][g] == c.id && (h = !0);
                d(b, c.id, g, h),
    ...
    a.fn.iTreegrid.parseOptions = function(b, c) {
        ...
        var e = a.extend({},
        a.fn.treegrid.parseOptions(b), a.fn.iTreegrid.defaults, c);
    ...
    a.fn.iTreegrid.defaults = {
        ...
        onClickRow: function(b) {
            ...
            if ("object" == typeof c.childTab) for (var j = c.childTab,
            f = 0; f < j.length; f++) {
                var k = a("#" + j[f].id),
                l = k.tabs("options"),
...
function(a) {
    ...
    a.fn.iUeditor.parseOptions = function(b, c) {
        var d = a.extend({},
        a.fn.textbox.parseOptions(b), a.fn.iUeditor.defaults, a.parser.parseOptions(b, ["id", "value"]), c);
        return setId(b, d)
    },
...
function(a) {
    a.fn.iUploadbox = function(b, c) {
        ...
        this.each(function() {
            ...
            0 == a("#" + b.id + "-btn").length && (a(this).closest("form").append('<button type="button" class="layui-btn" id="' + b.id + '-btn" style="display: none;">上传图片</button>'), layui.use("upload",
            function() {
                var a = layui.jquery,
                c = layui.upload;
                c.render({
                    ...
                    before: function(a) {
                        ...
                        c.statusCode == topJUI.config.statusCode.success ? a("#" + b.id).textbox("setValue", c.filePath) : layer.msg(c.message, {
                            icon: 5
                        }),
                        layer.closeAll("loading")
                    },
    ...
    a.fn.iUploadbox.parseOptions = function(b, c) {
        var d = a.extend({},
        a.fn.textbox.parseOptions(b), a.fn.iUploadbox.defaults, a.parser.parseOptions(b, ["id", "value"]), c);
        return setId(b, d)
    },
...
function(a) {
    ...
    a.fn.iUploader.parseOptions = function(b, c) {
        var d = a.extend({},
        a.fn.textbox.parseOptions(b), a.fn.iUploader.defaults, a.parser.parseOptions(b, ["id", "value"]), c);
        return setId(b, d)
    },
    a.fn.iUploader.defaults = {
        hasDownArrow: !1
    },
    a.parser && a.parser.plugins && a.parser.plugins.push("uploader")
} (jQuery),
function(a) {
    ...
    a.fn.iValidatebox.parseOptions = function(b, c) {
        var d = a.extend({},
        a.fn.validatebox.parseOptions(b), a.fn.iValidatebox.defaults, a.parser.parseOptions(b, ["id"]), c);
        return setId(b, d)
    },
...
function(a) {
    ...
    a.fn.iWindow.parseOptions = function(b, c) {
        var d = a.extend({},
        a.fn.window.parseOptions(b), a.fn.iWindow.defaults, a.parser.parseOptions(b, ["id"]), c);
        return setId(b, d)
    },
...
function(a) {
    ...
    a.fn.iZtree.methods = {},
    a.fn.iZtree.parseOptions = function(b, c) {
        var d = a.extend({},
        a.fn.iZtree.defaults, a.parser.parseOptions(b, ["id", "value"]), c);
        return setId(b, d)
    },
    a.fn.iZtree.defaults = {
        setting: {}
    },
    a.parser && a.parser.plugins && a.parser.plugins.push("ztree")
} (jQuery);