...
<div data-toggle="topjui-layout" data-options="fit:true">
    <div data-toggle="topjui-panel" title="" data-options="fit:true,iconCls:'icon-ok',footer:'#footer'">
        <form:form class="hidden" id="inputForm" action="${ctx}/sys/area/save" 
        method="post" data-toggle="topjui-form" data-options="" modelAttribute="area">
		<form:hidden path="id"/>
        ...
        <table class="editTable" style="margin-left: 50px;">
            ...
            <tr>
                ...
                <td>
                    ...
                    url:'${ctx}/sys/dict/findListByType?type=sys_area_type',
                    valueField:'title',
                    textField:'text',
            ...
            <tr>
                ...
                data-toggle="topjui-textarea" data-options="" >${area.remarks }</textarea></td>
            </tr>
        </table>
   	</form:form>
 	</div>
