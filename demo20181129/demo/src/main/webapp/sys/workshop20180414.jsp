	...
	<tr>
		<td>
		    ...
		    <div class="panel_box row"  style="margin-left: 2px;width: 98%;">
		        <div class="panel col">
		            <a href="javascript:openDetail('待审批任务');" data-url="${ctx }/html/page/message/message.html">
	...
	<tr id="tr-three">
		<td>
			<div id="allMission" data-toggle="topjui-accordion" style="margin-left: 10px;width: 98%;">
				<div title="待审批任务" data-options="iconCls:'fa fa-search'" style="overflow:auto;padding:10px;height: 400px;">
...
function openDetail(id){
	...
	{
		addTab("${ctx }/wf/operationRecord/list?requestType=workshop&myQueryType=created","审批记录",true);
	}
	else if("知会任务"==id)
	{
		addTab("${ctx }/wf/operationRecord/list?requestType=workshop&myQueryType=zhihui","审批记录",true);
	}
	else if("我审批完的记录"==id)
	{
		addTab("${ctx }/wf/operationRecord/list?requestType=workshop&myQueryType=yishenpi","审批记录",true);
	}
	else if("我创建并已结束的审批"==id)
	{
		addTab("${ctx }/wf/operationRecord/list?requestType=workshop&myQueryType=yiwancheng","审批记录",true);
	}	
	if("待审批任务"==id || "紧急催办任务"==id)	
	{
