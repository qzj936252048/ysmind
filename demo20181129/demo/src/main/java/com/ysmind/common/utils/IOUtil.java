 ...
 * @author:		Chembo Huang 
 * @since:		Dec 10, 2009
 * @modified:	Dec 10, 2009
 * @version:	  
 */

public abstract class IOUtil extends IOUtils {
    ...
    /**
     * Reads the contents from a given full path file name.
     */
    public static String readString(String fileNameWithFullPath) throws IOException
    {    	
    	return readString(new File(fileNameWithFullPath));
    }
    ...
    public static void writeStream(InputStream in, String destPath) throws IOException {
