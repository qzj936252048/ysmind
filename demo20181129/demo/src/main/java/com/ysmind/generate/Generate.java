...
import com.ysmind.common.utils.FreeMarkers;
...
public class Generate {
	...
	public static void main(String[] args) throws Exception {
		...
		// 模板文件路径
		String tplPath = StringUtils.replace(projectPath+"/src/main/java/com/ysmind/jeesite/generate/template", "/", separator);
		...
		// 视图文件路径
		String viewPath = StringUtils.replace(projectPath+"/src/main/webapp/views", "/", separator);
