...
public class Constants implements Serializable {
	...
	public static final String FORM_TYPE_STUDENT = "form_student";//学生管理
	...
	public static final String FORM_TYPE_LEAVE_APPLY = "form_leave_apply";//请假单
	public static final String FORM_TYPE_BUSINESS_APPLY = "form_business_apply";//出差申请单
	...
	public static final String FORM_TYPE_GOODS_MANAGER_PROVIDER = "form_goods_manager_provider";
	public static final String FORM_TYPE_GOODS_MANAGER_CUSTOMER = "form_goods_manager_customer";
	...
	public static final String FORM_TYPE_LEAVE_APPLY_ENEITY = "LeaveApply";//请假单
	public static final String FORM_TYPE_BUSINESS_APPLY_ENEITY = "BusinessApply";//出差申请单
	...
	public static final String FORM_TYPE_SAMPLE_PURCHASE_ORDER_ENEITY = "SamplePurchaseOrder";
	public static final String FORM_TYPE_SAMPLE_GUEST_ORDER_ENEITY = "SampleGuestOrder";
	...
	public static final String TABLE_NAME_SHOP = "shop_shop";//
	
	
	
	public static final String TABLE_NAME_QMAN_CONTROL_PLAN = "plan_qman_control_plan";//
	public static final String TABLE_NAME_QMAN_CONTROL_PLAN_LINE = "plan_qman_control_plan_line";//
	public static final String TABLE_NAME_QMAN_CONTROL_PLAN_DETAIL = "plan_qman_control_plan_detail";//
	public static final String TABLE_NAME_QMAN_CONTROL_CHANGE = "plan_qman_control_plan_detail_check";//
	public static final String TABLE_NAME_QMAN_CONTROL_PERSISTANT = "plan_qman_control_plan_detail_check";//
	
	
	public static final String TABLE_NAME_EMAIL_WAIT_SEND = "sys_email_wait_send";//
	public static final String TABLE_NAME_EMAIL_WAIT_OPERATION = "sys_email_wait_operation";//
	public static final String TABLE_NAME_EMAIL_SEND_SUCCESS = "sys_email_send_success";//
	public static final String TABLE_NAME_EMAIL_OPERATION_SUCCESS = "sys_email_operation_success";//
