...
public class Menu extends IdEntity<Menu> {
	...
	public static MenuModel changeEntityToModel(Menu entity,String fromType){
		MenuModel entityModel = new MenuModel();
		if(null != entity)
		{
			if(null != entity.getParent())
			{
				entityModel.setParentId(entity.getParent().getId());
				entityModel.setParentName(entity.getParent().getName());
			}
			...
			if(StringUtils.isNotBlank(fromType))
			{
				...
				{
					List<Menu> children = entity.getChildList();
				...
				{
					entityModel.setText(entity.getName());
					entityModel.setUrl(entity.getHref());
					entityModel.setTarget(entity.getTarget());
					entityModel.setIconCls(entity.getIcon());
					entityModel.setSort(entity.getSort());
					entityModel.setState(entity.getIsShow());
					//注意：如果href有值的话会优先去href的
					entityModel.setHref(null);
				}
			}
	...
	public static List<MenuModel> changeToModel(List<Menu> list,String fromType)
	{
		if(null != list && list.size()>0)
		{
			...
			for(Menu menu : list)
			{
				modelList.add(changeEntityToModel(menu,fromType));
			}
			return modelList;
		}
		return null;
