...
public class Log extends BaseEntity<Log> {
	...
	public static LogModel changeEntityToModel(Log entity){
		LogModel entityModel = new LogModel();
		if(null != entity)
		{
	...
	public static List<LogModel> changeToModel(List<Log> list)
	{
		if(null != list && list.size()>0)
		{
			List<LogModel> modelList = new ArrayList<LogModel>();
			for(Log entity : list)
			{
