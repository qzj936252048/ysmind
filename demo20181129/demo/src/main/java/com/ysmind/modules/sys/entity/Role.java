...
public class Role extends IdEntity<Role> {
	...
	public List<String> getOfficeIdList() {
		...
		List<Office> list = UserUtils.findByRoleId(getId());
	...
	@Transient
	public List<String> getOfficeIdList(String roleId) {
		List<String> officeIdList = Lists.newArrayList();
		List<Office> list = UserUtils.findByRoleId(roleId);
		for (Office office : list) {
			officeIdList.add(office.getId());
		}
		return officeIdList;
	...
	public void setOfficeIds(String officeIds) {
		...
		if (officeIds != null){
			...
			for (String officeId : ids) {
				Office office = new Office();
				officeList.add(UserUtils.getOfficeById(officeId));
			}
		}
	}
