...
public class Area extends IdEntity<Area> {
	...
	public static AreaModel changeEntityToModel(Area entity){
		AreaModel entityModel = new AreaModel();
		if(null != entity)
		{
			...
			List<Area> children = entity.getChildList();
	...
	public static List<AreaModel> changeToModel(List<Area> list)
	{
